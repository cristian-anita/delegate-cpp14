# A non-owning, const-correct and equality comparable callable wrapper.
...
- The solutions presented in *references* directory are not const-correct (they have the same problem as `::std::function`).
